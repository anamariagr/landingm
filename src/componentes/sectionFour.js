                        ...
                        <div className="col-md-12">
                            <div className="row letter-color pt-0">
                                    ...
                                    <div className="col-md-12 pb-2">
                                        ...
                                        <div className="col-md-12">
                                            <p>
                                            Si colaboras o eres dueño de un bar, café o restaurante y te interesa aumentar tus ventas durante los horarios donde normalmente no tienes clientes, actívate en nuestra plataforma y convierte tu establecimiento en un espacio de trabajo colaborativo (Coworking).                                           </p>
                                        </div>
                                        <div className="col-md-12">
                                                <p className="title-sub">
                                                Sabes cuantos vendes , pero no sabes a quien?                                                </p>
                                            </div>
                                        <div className="col-md-12">
                                        <p>
                                        ...
                                        <div className="col-md-12 text-right pt-5 ">  
                                            <a rel="noopener noreferrer" target="_blank" href="https://julian723095.typeform.com/to/ebI2gY"><button type="button"  className="btn btn-download bg-white">Activar mi establecimiento</button> </a>
                                        </div>
